...
from sitewomen.settings.components import config
from sitewomen.settings.components.common import (
    DATABASES,
    INSTALLED_APPS,
    MIDDLEWARE,
)
# from sitewomen.settings.components.csp import (
#     CSP_CONNECT_SRC,
#     CSP_IMG_SRC,
#     CSP_SCRIPT_SRC,
# )
...
MIDDLEWARE = (  # noqa: WPS440
    # выбрасывает исключение наличии проблем n+1
